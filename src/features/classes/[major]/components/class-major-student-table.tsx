...
import StudentForm from './student-form/add-student-form';
import { createClient } from '@/utils/supabase/client';
import { useEffect, useState } from 'react';
import { deleteStudent } from '../actions/student';
import UpdateStudentForm from './student-form/update-student-form';
import { FormattedStudent } from '@/features/classes/types/classes';
...
export default function ClassMajorStudentTable({
  data,
  classID,
}: ClassTableProps) {
